		...
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  	...
		  	<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn   buttons-radius features" href="#features" data-transition="<?php echo $transitionefect ?>">Meet Our Surgeons</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius blog" href="#features" data-transition="<?php echo $transitionefect ?>">Face</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius galery" href="#features" data-transition="<?php echo $transitionefect ?>">Breast</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius aboutus" href="#features" data-transition="<?php echo $transitionefect ?>">Body</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius office" href="#features" data-transition="<?php echo $transitionefect ?>">Other</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius office" href="#features" data-transition="<?php echo $transitionefect ?>">Photo Gallery</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius office" href="#features" data-transition="<?php echo $transitionefect ?>">Surgery Center</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius aboutus" href="#features" data-transition="<?php echo $transitionefect ?>">Testimonials</a></div>
				</div>				
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<!--<div class="ui-grid-b marginside">
		 		...
		 		<h2>WELCOME TO COSMETIC SURGEONS OF NAPLES</h2>
		 		<img src="img/Doctors.jpg" alt="">
		 		<p>Looking great and feeling good enhances your self esteem and self confidence in all aspects of the life be it personal or at work. Aesthetic Plastic Surgery is an art which must also take into consideration your individualized goals and desires. We at Cosmetic Surgeons of Naples, CSN aim to help you achieve your personal goals.</p>
		 		<p>Dr. Nalin Master and Dr. Rebecca Crane have been practicing Aesthetic Surgery in Naples, Florida since 1983 and 1990 respectively. They have cared for many satisfied patients and their families for all these years and continue to do so. Both, Dr. Master and Dr. Crane are Board Certified Plastic Surgeons, certified by American Board of Plastic Surgery. It is important to verify this qualification when choosing a Plastic Surgeon. Both, Dr. Master and Dr. Crane specialize in Facial Rejuvenation, Breast Surgery, Body Contouring and Liposuction. Additionally, they also offer Non-Invasive procedures like Injectables, Restylane, Juvederm, Radiesse and BOTOX.</p>
		 		<p>At Cosmetic Surgeons of Naples, surgery is performed on site at our outpatient Ambulatory Surgery Center. Newgate Surgery Center. Newgate Surgery Center is state certified by the Agency for Health Care Administration assuring it meets the most rigorous standards and safety requirements. Our onsite surgical facility allows us to provide your care in a private, safe and friendly setting.</p>
		 		<p>We strive to provide the Best Plastic surgical care. Dr. Master and Dr. Crane provide each patient individualized professional attention before during and after surgery. Our goal is your satisfaction and comfort, provided in an intimate, private setting. We Thank you for your continued support and look forward to meeting with you to discuss your expectation.</p>
		 		<p>Dr. Master and Dr. Crane are serving Naples, Fort Myers, Bonita Springs, Estero and Marco Island.</p>
				<img src="img/scenter_03_large.jpg" alt="">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-features">
						<ul id="menu-features" class="menu-hide">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Meet Our Surgeons</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Face</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Breast</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Body</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Other</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Photo Gallery</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Surgery Center</a></li>
